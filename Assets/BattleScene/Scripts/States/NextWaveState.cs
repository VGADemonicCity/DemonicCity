...
namespace DemonicCity.BattleScene
{
    ...
    public class NextWaveState : StatesBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                if (state != BattleManager.StateMachine.State.NextWave || m_battleManager.m_StateMachine.PreviousStateIsPause || m_battleManager.m_StateMachine.PreviousStateIsDebugging) // StateがNextWave以外の時は処理終了
                {
                    return;
                }
