...
public class FadeManager : MonoBehaviour
{
    ...
    static void Init()
    {
        ...
        //Imageのサイズは適当に設定
        fadeImage.rectTransform.sizeDelta = new Vector2(1600, 900);
    }
    ...
    /// <param name="n">遷移先のscene index</param>
    /// <param name="time">遷移に掛ける時間</param>
    public static void FadeOut(int n, float time)
    {
        fadeTime = time;
        if (fadeImage == null) Init();
        nextScene = n;
